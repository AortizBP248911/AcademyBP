...
const navItems = [
  { name: "Mis Cursos", href: "/dashboard", icon: SquaresFour },
  { name: "Explorar Cursos", href: "/dashboard/browse", icon: MagnifyingGlass },
  { name: "Mis Logros", href: "/dashboard/achievements", icon: Trophy },
]
...
export default function UserSidebar({ user }: { user: any }) {
  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r border-gray-100 bg-white sticky top-0 hidden md:flex">
      <div className="flex h-14 items-center border-b border-gray-100 px-6 font-bold text-lg gap-2">
