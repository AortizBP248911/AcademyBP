...
export default function UserSidebar({ user }: { user: any }) {
  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r bg-white sticky top-0 hidden md:flex">
      <div className="flex h-14 items-center border-b px-6 font-bold text-lg gap-2">
