  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight text-black">Mis Logros</h1>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {achievements.map((achievement) => (
          <div key={achievement.id} className="bg-white rounded-lg border shadow-sm p-6 flex flex-col items-center text-center space-y-4 hover:shadow-md transition-shadow">
          ...
          <div className="col-span-full rounded-lg border border-dashed p-12 text-center text-gray-600">
            <div className="flex flex-col items-center justify-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Completa tus cursos al 100% para ganar insignias y reconocimientos.</p>
                </div>
            </div>
          </div>
        )}
