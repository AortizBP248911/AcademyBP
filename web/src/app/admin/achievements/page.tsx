  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight text-black">Logros de Usuarios</h1>
      ...
      <div className="grid gap-6">
        ...
        {usersWithAchievements.length === 0 && (
            <div className="rounded-lg border border-dashed p-12 text-center text-gray-600 bg-white">
                <div className="flex flex-col items-center justify-center gap-2">
                    <Trophy size={32} className="text-gray-300" />
                    <p>No hay logros registrados aún.</p>
                    <p className="text-xs text-gray-400">Usa el botón "Asignar Logro" para otorgar insignias manualmente.</p>
                </div>
            </div>
        )}
      </div>
